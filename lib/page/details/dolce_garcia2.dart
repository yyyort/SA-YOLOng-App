...
class DolseGarciaHall2 extends ConsumerWidget {
  const DolseGarciaHall2({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final stream = ref.watch(dolceGarciaStream2);
    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          const ImageCaro(location: 'Dolse Garcia Hall 2'),
          const SizedBox(
            height: 10,
          ),
        ],
